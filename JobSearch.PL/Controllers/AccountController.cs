    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                ...
                else ViewBag.Error = "Якесь з полів пусте!";
                return View(model);
            }
            else
            {
                ...
                {
                    ViewBag.Error = "Логін, чи пароль не вірний!";
                    return View(model);
                }
        ...
        {
            ViewBag.Role = new SelectList(new string[] { "Pоботодавець", "Kористувач" });
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    City = model.City,
                    Role = model.Role == "Kористувач" ? Role.RegisterUser.ToString() : Role.Employer.ToString(),
