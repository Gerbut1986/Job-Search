namespace JobSearch.PL.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "Це поле є обов'язковим! Будь ласка, заповніть його.")]
        ...
        [Required]
        [StringLength(100, ErrorMessage = "{0} має містити принаймні {2} символів.", MinimumLength = 6)]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string Password { get; set; }
